...
- [ ] **Google Business Profile** (geprüft 2026-08-28): Eintrag „Praxis für Physiotherapie Astrid Mally" existiert, 4,7★ (20 Rezensionen), beansprucht (es gibt „Vom Inhaber"-Fotos). **Website-URL stimmt bereits** (physiotherapie-mally.de → zeigt seit dem Umzug automatisch auf die neue Seite). **Öffnungszeiten dort veraltet**: Di/Do stehen auf 16:00 (richtig: 16:30), Fr auf 16:00 (richtig: 15:00); Mo/Mi 19:00 stimmen. Zu klären: Wer hat Zugriff auf das Profil (Astrids Google-Konto?) — dann unter business.google.com die drei Tage korrigieren. Falls kein Zugang mehr: bei Google „Zugriff anfordern".
